package com.app.carnavar.utils.math;
...
public class Matrix2 {
    ...
    public static void matrixAdd(Matrix2 ma,
                                 Matrix2 mb,
                                 Matrix2 mc) {
        assert(ma != null);
        assert(mb != null);
    ...
    public static void matrixSubtract(Matrix2 ma,
                                      Matrix2 mb,
                                      Matrix2 mc) {
        assert(ma != null);
        assert(mb != null);
    ...
    public static void matrixMultiply(Matrix2 ma,
                                      Matrix2 mb,
                                      Matrix2 mc) {
        assert(ma != null);
        assert(mb != null);
    ...
    public static void matrixMultiplyByTranspose(Matrix2 ma,
                                                 Matrix2 mb,
                                                 Matrix2 mc) {
        assert(ma != null);
        assert(mb != null);
    ...
    public static void matrixTranspose(Matrix2 mtxin,
                                       Matrix2 mtxout) {
        assert(mtxin != null);
        assert(mtxout != null);
    ...
    public static boolean matrixEq(Matrix2 ma,
                                   Matrix2 mb,
                                   double eps) {
        assert(ma != null);
        assert(mb != null);
    ...
    public static void matrixCopy(Matrix2 mSrc,
                                  Matrix2 mDst) {
        assert(mSrc != null);
        assert(mDst != null);
    ...
    public static boolean matrixDestructiveInvert(Matrix2 mtxin,
                                                  Matrix2 mtxout) {
        assert(mtxin != null);
        assert(mtxout != null);
    ...
    public static void matrixSubtractFromIdentity(Matrix2 m) {
        int r, c;
        for (r = 0; r < m.rows; ++r) {
            for (c = 0; c < r; ++c)
