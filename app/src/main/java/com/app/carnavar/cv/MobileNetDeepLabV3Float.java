...
public class MobileNetDeepLabV3Float extends TFLiteImageSemanticSegmenter {
    ...
    private static final String MODEL_FILEPATH = "cvmodels/deeplabv3/deeplabv3_257_mv_gpu.tflite";

    public MobileNetDeepLabV3Float(Context activity) throws IOException {
        super(activity);
    }
